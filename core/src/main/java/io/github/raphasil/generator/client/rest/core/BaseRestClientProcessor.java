...
package io.github.raphasil.generator.client.rest.core;
...
import io.github.raphasil.generator.client.rest.core.helper.ElementHelper;
import io.github.raphasil.generator.client.rest.core.helper.HttpAnnotationHelper;
import io.github.raphasil.generator.client.rest.core.logger.ProcessorLogger;
...
public abstract class BaseRestClientProcessor extends AbstractProcessor {
	...
	private MethodSpec generateMethod(final TypeElement interfaceAnnotated, final String basePath, final Map<String, String> baseHeaders,
		...
		return MethodSpec.methodBuilder(ElementHelper.getSimpleName(methodAnnoted))
				...
				.addCode(buildCode(codeScopeBuilder.build()))
				.build();
	}
